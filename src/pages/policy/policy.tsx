  ...
  return (
    <Page>
      <div className={s.wrapper}>
        <Typography.Title view="xsmall" weight="bold" tag="h1">
            ...
            <ol className={s.list}>
              ...
              <li>
                <Typography.Text view="primary-medium">
                  ...
                  адресу https://store.alfabank.ru;
                </Typography.Text>
              </li>
              <li>
                <Typography.Text view="primary-medium">
            ...
            <ol className={s.list}>
              <li>
                <Typography.Text view="primary-medium">
                  ...
                  https://store.alfabank.ru; уточнение деталей заказа.
                </Typography.Text>
              </li>
              <li>
                <Typography.Text view="primary-medium">
            ...
            <ol className={s.list}>
              <li>
                <Typography.Text view="primary-medium">
                  ...
                  https://store.alfabank.ru. Заполняя соответствующие формы
            ...
            <ol className={s.list}>
              ...
              <li>
                <Typography.Text view="primary-medium">
                  ...
                  сети Интернет по адресу https://store.alfabank.ru/policy.
                </Typography.Text>
              </li>
            </ol>
          </li>
